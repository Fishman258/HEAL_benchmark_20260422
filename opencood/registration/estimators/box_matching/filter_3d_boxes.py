...
from opencood.registration.estimators.box_matching.corresponding_detector import CorrespondingDetector
...
if __name__ == "__main__":
    raise SystemExit(
        "Filter3dBoxes is a library module. The old legacy.visualize debug "
        "entrypoint was removed during project cleanup."
    )
