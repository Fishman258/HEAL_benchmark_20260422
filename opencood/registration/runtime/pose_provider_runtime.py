"""Runtime bridge that applies pose correction before fusion."""
...
try:
    from opencood.registration.runtime.online_feature_refiner import (
...
def _ensure_online_runtime(cfg: PoseProviderConfig) -> Tuple[Optional[Any], Optional[Mapping[str, Any]], Optional[Mapping[str, Any]]]:
    ...
    if cfg._online_corrector is None and cfg.online_method:
        try:
            from opencood.registration.runtime.pose_solver import build_pose_corrector
