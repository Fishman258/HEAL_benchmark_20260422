...
from opencood.fusion.modules.fusion_in_one import MaxFusion, AttFusion, DiscoFusion, V2VNetFusion, V2XViTFusion, CoBEVT, Where2commFusion, Who2comFusion
from opencood.fusion.modules.pastat_fusion import PASTATFusion
...
class HeterModelBaseline(nn.Module):
    def __init__(self, args):
        ...
        for modality_name in self.modality_name_list:
            ...
            # import model
            encoder_filename = "opencood.detection.models.heter_encoders"
    ...
    def forward(self, data_dict):
        ...
        if self.record_runtime_features:
            self._runtime_feature_store.update({
                'pairwise_t_matrix': pairwise_t_matrix.detach().cpu(),
                'affine_matrix': affine_matrix.detach().cpu(),
            })
