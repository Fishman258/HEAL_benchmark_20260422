from opencood.fusion.datasets.late_fusion_dataset import getLateFusionDataset
from opencood.fusion.datasets.late_heter_fusion_dataset import getLateheterFusionDataset
from opencood.fusion.datasets.early_fusion_dataset import getEarlyFusionDataset
from opencood.fusion.datasets.intermediate_fusion_dataset import getIntermediateFusionDataset
from opencood.fusion.datasets.intermediate_2stage_fusion_dataset import getIntermediate2stageFusionDataset
from opencood.fusion.datasets.intermediate_heter_fusion_dataset import getIntermediateheterFusionDataset

from opencood.fusion.datasets.heter_infer.intermediate_heter_infer_fusion_dataset import getIntermediateheterinferFusionDataset
...
from opencood.data_utils.datasets.basedataset.v2vloc_basedataset import V2VLOCBaseDataset
...
def build_dataset(dataset_cfg, visualize=False, train=True):
    ...
    assert dataset_name in ['opv2v', 'v2xsim', 'dairv2x', 'v2xset', 'v2vloc', 'v2v4real']
