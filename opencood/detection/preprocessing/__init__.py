...
from opencood.detection.preprocessing.base_preprocessor import BasePreprocessor
from opencood.detection.preprocessing.voxel_preprocessor import VoxelPreprocessor
from opencood.detection.preprocessing.bev_preprocessor import BevPreprocessor
from opencood.detection.preprocessing.sp_voxel_preprocessor import SpVoxelPreprocessor
...
def build_preprocessor(preprocess_cfg, train):
    ...
    error_message = f"{process_method_name} is not found. " \
                     ...
                     f"detection/preprocessing/__init__.py"
